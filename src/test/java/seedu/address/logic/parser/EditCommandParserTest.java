...
public class EditCommandParserTest {
    ...
    private static final String TUTORIAL_EMPTY = " " + PREFIX_TUTORIAL_NAME;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // address
        userInput = targetIndex.getOneBased() + HANDLE_DESC_AMY;
        descriptor = new EditStudentDescriptorBuilder().withHandle(VALID_HANDLE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + HANDLE_DESC_AMY + EMAIL_DESC_AMY + TUTORIAL_DESC_1
                        + PHONE_DESC_AMY + HANDLE_DESC_AMY + EMAIL_DESC_AMY + TUTORIAL_DESC_1 + PHONE_DESC_BOB
                        + HANDLE_DESC_BOB + EMAIL_DESC_BOB + TUTORIAL_DESC_2;

        assertParseFailure(parser, userInput,
                        Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE, PREFIX_EMAIL, PREFIX_HANDLE));

        // multiple invalid values
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_HANDLE_DESC + INVALID_EMAIL_DESC
                        + INVALID_PHONE_DESC + INVALID_HANDLE_DESC + INVALID_EMAIL_DESC;

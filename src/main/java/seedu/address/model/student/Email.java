...
/**
 * Represents a Student's email in the address book. Guarantees: immutable; is
...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain "
                    ...
                    + "The local-part must also not contain 2 consecutive special characters.\n"
                    + ("2. This is followed by a '@' and then a domain name. The domain "
                                    + "name is made up of domain labels ")
